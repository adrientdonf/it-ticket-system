...
// ─────────────────────────────────────────────────────────────────────────────
// CREATE TICKET (JWT SECURED)
// created_by now comes from req.user (decoded JWT), NOT from frontend
// ─────────────────────────────────────────────────────────────────────────────
const createTicket = async (req, res) => {
  ...
  try {
    ...
    // 🔥 FIX: secure user source (JWT)
    const created_by = req.user.username;

    const newId = await Ticket.createTicket({
      title,
      description,
      priority,
      created_by
